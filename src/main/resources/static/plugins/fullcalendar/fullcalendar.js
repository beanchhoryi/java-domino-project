...
// NOTE: this method is best because it takes weird zooming dimensions into register.html
...
var View = fc.View = Class.extend({
	...
	// Displays all-day ranges naturally, with an inclusive end. Takes the current isRTL into register.html.
